...
\section{Teoría y clasificación de la programación} % (fold)
\label{sec:teoria_clasificacion_programacion}
% section Teoría y clasificación de la programación (end)

\section{Una reseña de los problemas más comunes de programación} % (fold)
\label{sec:resena_problemas_comunes_programacion}
