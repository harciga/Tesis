...
Si $d_{ij} > 0$ se mantiene, el valor es también llamado un tiempo de latencia positivo, de lo contrario al ser $d_{ij} < 0$, se le llama tiempo de latencia negativo.
