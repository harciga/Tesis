...
\multicolumn{1}{l}{Criterio} & \multicolumn{1}{l}{Expresión} & \multicolumn{1}{l}{Significado} \\
  ...
  $T_{\max}$ & $\underset{i=1,\dots,n}{\max} (\max (C_i-d_i;0))$ & Tardanza máxima de los trabajos \\ 
  $L_{\max}$ & $\underset{i=1,\dots,n}{\max} (C_i-d_i)$ & Retardo máximo de los trabajos \\
  $E_{\max}$ & $\underset{i=1,\dots,n}{\max} (\max(d_i-C_i;0))$ & Precocidad máxima de los trabajos \\
