...
\section{Ejemplos de la notación}
\label{sub:notacion_ejemplos}

\subsection{Una fábrica de bolsas de papel}

\begin{simple}
\textbf{Un \textit{flow-shop} flexible}
...
\subsection{Asignación de puertas en un aeropuerto}

\begin{simple}
\textbf{Un entorno de máquinas paralelas}
