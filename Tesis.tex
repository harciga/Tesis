...
$FFc \lvert r_j \lvert \sum w_jT_j$ denota un \textit{flow-shop} flexible. Los trabajos tienen fechas de liberación y fechas de cierre y el objetivo es la minimización de la tardanza ponderada total. 
\end{simple}

\subsubsection{Una factoría de bolsas de papel}
