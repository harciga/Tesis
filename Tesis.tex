...
El objetivo a minimizar siempre es una función de los tiempos de compleción de los trabajos, los cuales, por supuesto, dependen del programa. 
%
El criterio clásico es sin duda alguna el que mide el tiempo de compleción de todos los trabajos. Este criterio se denota por $C_{max}$ y se llama 

El tiempo de compleción de la operación del trabajo $j$ en la máquina $i$ se denota por $C_{ij}$. 
