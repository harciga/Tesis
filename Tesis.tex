...
\[ L_j = C_j - d_j, \]
el cual es positivo cuando el trabajo $j$ es completado tardíamente y negativo cuando es completado anticipadamente. La tardanza (\textit{tardiness})jde un trabajo $j$ se define como
