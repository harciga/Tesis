...
La planeacion de lineas de flujo fue desarrollada en la decada de los 30 o aun mas temprano y las graficas de Milestone tambien estuvieron en uso regular para la decada de los 50. Los grandes contratos fueron subdivididos en secciones con fechas limite marcadas para el logro del trabajo requerido para alcanzar cada "Milestone". Sin embargo, tal como con las graficas de Gantt, todas las fechas y las relaciones mostradas en estas graficas estaban basadas en heuristicos o en la experiencia. Era posible identificar retrasos pero cualquier aseveracion del impacto del mismo estaba basada en un punto de vista personal de los datos y no de un analisis serio. Como consecuencia cuando el retraso de un programa se volvia aparente en grandes contratos, la tendencia era solucionar el problema inundandolo con mano de obra y "comprar tiempo" frecuentemente a un precio muy elevado.
